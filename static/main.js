...
function createGlobe() {
    const globeGeometry = new THREE.IcosahedronGeometry(1, 35);
...
function addCanvasEvents() {
    ...
    //             console.log(res[0].face.normal.x, res[0].face.normal.y, res[0].face.normal.z, res[0].face.normal);
